package com.shopify.encryption;
...
public class PasswordEncryption {
	...
	// return a base64 encoded AES encrypted text to be stored in password column
	...
	// this is for decrypting the password column
	public static String decrypt(String encryptedPassword, String email) {
		try {
			...
			// geting back the AES key from the same email and salt
